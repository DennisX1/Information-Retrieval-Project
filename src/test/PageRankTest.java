...
public class PageRankTest {
    ...
    @Test
    public void performCalculationsLargeScale() {
        ...
        double[] rank = PageRank.performCalculationsLargeScale(reviews, weights, 0.25);

        assertEquals(0.38, rank[0], 0.1);
        assertEquals(0.12, rank[1], 0.1);
        assertEquals(0.29, rank[2], 0.1);
        assertEquals(0.19, rank[3], 0.1);
    }
